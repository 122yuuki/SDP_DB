...
-> [PostgreSQLをインストールする(windows版)](https://github.com/122yuuki/SDP_DB/blob/main/Section_1/PostgreSQL_1.md)  
-> [PostgreSQLをインストールする(Mac版)](https://github.com/122yuuki/SDP_DB/blob/main/Section_1/PostgreSQL_2.md)  
